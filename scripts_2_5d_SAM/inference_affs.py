...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='2d_CAD_MEC_inference', help='path to config file')
    # parser.add_argument('-mn', '--model_name', type=str, default='2024-12-30--15-56-19_2d_SAM_MEC_slice1.0_aff1.0_cross1.0_interaction1.0_Lsam0.1_L3d1.0_interation1.0_v4')
    parser.add_argument('-mn', '--model_name', type=str, default='2024-04-24--10-15-40_2d_MEC_bs16_ps256_loss0.0_slice1.0_cross1.0_interaction1.0_3d_MEC_h160_noft_lr_ratio1_ft0')
    parser.add_argument('-id', '--model_id', type=int, default=178000)
    parser.add_argument('-m', '--mode', type=str, default='wafer36_2')
