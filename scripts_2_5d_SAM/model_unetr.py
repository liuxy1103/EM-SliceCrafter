...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        self.vit = ViT(
                        image_size = self.img_size[1:],          # image size
                        frames = self.img_size[0],               # number of frames
                        image_patch_size = self.patch_size[1:],     # image patch size
                        frame_patch_size = self.patch_size[0],      # frame patch size
                        channels=1,
                        num_classes = 1000,
                        dim = hidden_size,
                        depth = 12, # 12
