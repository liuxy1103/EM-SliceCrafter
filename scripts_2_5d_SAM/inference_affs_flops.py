...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='2d_bs16_ps256_loss1.0_slice1.0_cross1.0_interaction1.0', help='path to config file')
    parser.add_argument('-mn', '--model_name', type=str, default='2023-09-23--12-45-47_2d_bs16_ps256_loss1.0_slice1.0_cross1.0_interaction1.0_3d_z16_h160_nft189k_lr_ratio0.1_ft10000')
    parser.add_argument('-id', '--model_id', type=int, default=189000)
