...
class Provider_valid(Dataset):
    def __init__(self, cfg, valid_data=None, num_z=18, test=False, test_split=None):
        ...
        if cfg.MODEL.model_type == 'superhuman':
            ...
            if valid_dataset_name == 'zebrafinch' or valid_dataset_name == 'zebrafinch_test' or valid_dataset_name == 'zebrafinch_test_128':
            ...
            #     self.crop_size = [53, 134, 134]
            #     self.net_padding = [14, 56, 56]
        ...
        self.num_z = 18 # 避免报错用测试crop[16,128,128]
        ...
        for k in range(len(self.train_datasets)):
            ...
            elif valid_dataset_name == 'zebrafinch' or valid_dataset_name == 'zebrafinch_test' or valid_dataset_name == 'zebrafinch_test_128':  # 20240422
