...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='3d_superhuman_zebrafinch_pure_raw_inference', help='path to config file')
    parser.add_argument('-mn', '--model_name', type=str, default='2025-06-14--10-08-40_3d_superhuman_zebrafinch_pure_raw')
    parser.add_argument('-id', '--model_id', type=int, default=90000)
