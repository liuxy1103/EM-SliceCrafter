...
class SegMamba(nn.Module):
    def __init__(
        ...
        # feat_size=[192, 384, 768, 1536],  # 1008.91M
...
# def segmamba_base_hid512_2222(**kwargs):
#     model = SegMamba(
#         depths=[2,2,2,2], feat_size=[32,64,128,256], hidden_size=512, kernel_size=(1,3,3), **kwargs
#     )
#     return model

# def segmamba_base_hid512_3333(**kwargs):
#     model = SegMamba(
#         depths=[3,3,3,3], feat_size=[32,64,128,256], hidden_size=512, kernel_size=(1,3,3), **kwargs
#     )
#     return model

# def segmamba_base_hid512_5555(**kwargs):
#     model = SegMamba(
#         depths=[5,5,5,5], feat_size=[32,64,128,256], hidden_size=512, kernel_size=(1,3,3), **kwargs
#     )
#     return model

# # def segmamba_deeper_hid512_22222(**kwargs):
# #     model = SegMamba(
# #         depths=[2,2,2,2,2], feat_size=[32,64,128,256], hidden_size=512, kernel_size=(1,3,3), **kwargs
# #     )
# #     return model


# segmamba_base_2222 = segmamba_base_hid512_2222
# segmamba_base_3333 = segmamba_base_hid512_3333
# segmamba_base_5555 = segmamba_base_hid512_5555
