...
from provider_valid_3d_vis import Provider_valid
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='3d_ac4_data80', help='path to config file')
    parser.add_argument('-mn', '--model_name', type=str, default='2023-09-18--02-44-49_3d_z16_h160_affs0-10')
    parser.add_argument('-emb', '--if_embedding', action='store_true', default=True)
    parser.add_argument('-id', '--model_id', type=int, default=188000)
    ...
    out_path = os.path.join('../inference_3d_vis', trained_model, args.mode)
