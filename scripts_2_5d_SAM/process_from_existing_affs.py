...
# Add the elf module to the Python path
script_dir = os.path.dirname(os.path.abspath(__file__))
elf_path = os.path.join(script_dir, 'elf-master', 'elf-master')
if os.path.exists(elf_path):
    sys.path.insert(0, elf_path)
...
try:
    ...
    print("WARNING: LMC module not available. Will only compute waterz segmentation.")
    LMC_AVAILABLE = False
...
if __name__ == "__main__":
    ...
    for vol_dir in tqdm(volume_dirs):
        ...
        if LMC_AVAILABLE and all_lmc_metrics:
            vol_txt.write(
                f'LMC segmentation metrics: '
                f'MSE={mse:.6f}, '
                f'BCE={bce_loss:.6f}, '
    ...
    # Print and save average waterz metrics
    avg_waterz_str = (
    ...
    # Calculate and print average LMC metrics if available
    if LMC_AVAILABLE and all_lmc_metrics:
        avg_lmc = {
